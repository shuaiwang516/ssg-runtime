 ...
 * classifier only commits to dominant upgrade-critical families per system plus
 * {@code BACKGROUND} and {@code UNKNOWN}; long-tail verb coverage is deferred
 * to Phase 5 profiles.
 */
public class ProtocolFamilyClassifierTest {
    ...
    public void cassandra_schemaPullVerbMapsToSchemaSync() {
        assertEquals(ProtocolFamily.CASSANDRA_SCHEMA_SYNC, ProtocolFamilyClassifier
                .classify("cassandra", "SCHEMA_PULL_REQ", null, null, null, null));
    }
    ...
    public void cassandra_migrationRequestVerbMapsToSchemaSync() {
        ...
        assertEquals(ProtocolFamily.CASSANDRA_SCHEMA_SYNC, ProtocolFamilyClassifier
                .classify("cassandra", "MIGRATION_REQUEST", null, null, null, null));
    }
    ...
    public void cassandra_paxosV2FallsIntoPaxosViaPrefix() {
        assertEquals(ProtocolFamily.CASSANDRA_PAXOS, ProtocolFamilyClassifier.classify("cassandra",
                "PAXOS2_COMMIT_REMOTE_REQ", null, null, null, null));
    }

    @Test
    public void cassandra_repairReqMapsToRepairOrStream() {
        assertEquals(ProtocolFamily.CASSANDRA_REPAIR_OR_STREAM, ProtocolFamilyClassifier
                .classify("cassandra", "REPAIR_REQ", null, null, null, null));
    }

    @Test
    public void cassandra_streamingInitiateMapsToRepairOrStream() {
        assertEquals(ProtocolFamily.CASSANDRA_REPAIR_OR_STREAM, ProtocolFamilyClassifier
                .classify("cassandra", "STREAM_INIT_MESSAGE", null, null, null, null));
    }
    ...
    public void cassandra_gossipPayloadFallbackMapsToBackground() {
        ...
        assertEquals(ProtocolFamily.BACKGROUND, ProtocolFamilyClassifier.classify("cassandra", null,
                null, null, null, "org.apache.cassandra.gms.GossipDigestSyn"));
    }
    ...
    public void hdfs_createMapsToNamespaceMutation() {
        assertEquals(ProtocolFamily.HDFS_CLIENT_NAMESPACE_MUTATION, ProtocolFamilyClassifier
                .classify("hdfs-rpc", null, "ClientNamenodeProtocol", "create", null, null));
    }

    @Test
    public void hdfs_deleteMapsToNamespaceMutation() {
        assertEquals(ProtocolFamily.HDFS_CLIENT_NAMESPACE_MUTATION, ProtocolFamilyClassifier
                .classify("hdfs-rpc", null, "ClientNamenodeProtocol", "delete", null, null));
    }

    @Test
    public void hdfs_addBlockMapsToBlockPipeline() {
        assertEquals(ProtocolFamily.HDFS_CLIENT_BLOCK_PIPELINE, ProtocolFamilyClassifier
                .classify("hdfs-rpc", null, "ClientNamenodeProtocol", "addBlock", null, null));
    }

    @Test
    public void hdfs_blockReportMapsToBlockPipeline() {
        assertEquals(ProtocolFamily.HDFS_CLIENT_BLOCK_PIPELINE, ProtocolFamilyClassifier
                .classify("hdfs-rpc", null, "DatanodeProtocol", "blockReport", null, null));
    }

    @Test
    public void hdfs_journalMapsToJournalQjm() {
        assertEquals(ProtocolFamily.HDFS_JOURNAL_QJM, ProtocolFamilyClassifier.classify("hdfs-rpc",
                null, "QJournalProtocol", "journal", null, null));
    }

    @Test
    public void hdfs_qjournalHeartbeatStaysInJournalWhenServiceHints() {
        assertEquals(ProtocolFamily.HDFS_JOURNAL_QJM, ProtocolFamilyClassifier.classify("hdfs-rpc",
                null, "QJournalProtocol", "newEpoch", null, null));
    }

    @Test
    public void hdfs_haTransitionMapsToHaCoordination() {
        assertEquals(ProtocolFamily.HDFS_HA_COORDINATION, ProtocolFamilyClassifier
                .classify("hdfs-rpc", null, "HAServiceProtocol", "transitionToActive", null, null));
    }

    @Test
    public void hdfs_heartbeatMapsToBackground() {
        assertEquals(ProtocolFamily.BACKGROUND, ProtocolFamilyClassifier.classify("hdfs-rpc", null,
                "DatanodeProtocol", "sendHeartbeat", null, null));
    }
    ...
    public void hdfs_getFileInfoMapsToBackground() {
        ...
        assertEquals(ProtocolFamily.BACKGROUND, ProtocolFamilyClassifier.classify("hdfs-rpc", null,
                "ClientNamenodeProtocol", "getFileInfo", null, null));
    }
    ...
    public void hbase_mutateMapsToClientMutation() {
        assertEquals(ProtocolFamily.HBASE_CLIENT_MUTATION_OR_MULTI, ProtocolFamilyClassifier
                .classify("hbase", null, "ClientService", "Mutate", null, null));
    }

    @Test
    public void hbase_multiMapsToClientMutation() {
        assertEquals(ProtocolFamily.HBASE_CLIENT_MUTATION_OR_MULTI, ProtocolFamilyClassifier
                .classify("hbase", null, "ClientService", "Multi", null, null));
    }
    ...
    public void hbase_openRegionMapsToRegionAdminLifecycle() {
        assertEquals(ProtocolFamily.HBASE_REGION_ADMIN_LIFECYCLE, ProtocolFamilyClassifier
                .classify("hbase", null, "AdminService", "OpenRegion", null, null));
    }

    @Test
    public void hbase_replicateWalEntryMapsToRegionAdminLifecycle() {
        assertEquals(ProtocolFamily.HBASE_REGION_ADMIN_LIFECYCLE, ProtocolFamilyClassifier
                .classify("hbase", null, "AdminService", "ReplicateWALEntry", null, null));
    }

    @Test
    public void hbase_createTableMapsToMasterSchemaDdl() {
        assertEquals(ProtocolFamily.HBASE_MASTER_SCHEMA_DDL, ProtocolFamilyClassifier
                .classify("hbase", null, "MasterService", "CreateTable", null, null));
    }

    @Test
    public void hbase_createNamespaceMapsToMasterSchemaDdl() {
        assertEquals(ProtocolFamily.HBASE_MASTER_SCHEMA_DDL, ProtocolFamilyClassifier
                .classify("hbase", null, "MasterService", "CreateNamespace", null, null));
    }
    ...
    public void upgradeCriticalFamiliesAdvertiseUpgradeCriticalClass() {
        ProtocolFamily[] upgradeCritical = {ProtocolFamily.CASSANDRA_SCHEMA_SYNC,
                ...
                ProtocolFamily.HDFS_HA_COORDINATION, ProtocolFamily.HBASE_CLIENT_MUTATION_OR_MULTI,
    ...
    public void classifyClass_matchesClassifyFamilyClass() {
        assertEquals(ProtocolFamily.CASSANDRA_SCHEMA_SYNC.familyClass(), ProtocolFamilyClassifier
                .classifyClass("cassandra", "SCHEMA_PULL_REQ", null, null, null, null));
    }
