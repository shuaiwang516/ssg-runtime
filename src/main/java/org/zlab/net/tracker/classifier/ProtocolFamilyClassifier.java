 ...
 *
 * <p>Phase 1 deliberately keeps this classifier small — it only commits to
 * the dominant upgrade-critical families per system and routes everything
 * else to {@link ProtocolFamily#BACKGROUND} or
 * {@link ProtocolFamily#UNKNOWN}. Long-tail verb and method coverage is the
 * job of Phase 5 profile generation, not this file.
 *
 * <p>The classifier consumes the raw attributes populated by the
 * instrumentation bridge:
 * <ul>
 * <li>{@code protocol}: system identifier ({@code cassandra},
 * {@code hdfs-rpc}, {@code hbase}).</li>
 * <li>{@code messageType}: Cassandra internode verb / HBase simple type /
 * HDFS request class name.</li>
 ...
 * <li>{@code messageKind}: optional subtype qualifier (HBase mutate
 * subtype, etc.).</li>
 * <li>{@code payloadType}: simple payload class name (useful as a
 * last-resort fallback).</li>
 * </ul>
 *
 * <p>Classification priority within a system matches the Phase 1 plan:
 * <ol>
 * <li>Cassandra: internode verb → {@code messageKind} / channel →
 * payload type.</li>
 * <li>HDFS: {@code rpcService} + {@code rpcMethod} → payload wrapper
 * class.</li>
 * <li>HBase: {@code rpcService} + {@code rpcMethod} →
 * {@code messageKind} for mutate subtype → request class.</li>
 * </ol>
 */
public final class ProtocolFamilyClassifier {
    ...
    private static final Set<String> CASSANDRA_SCHEMA_VERBS = buildVerbSet(
            ...
            "SCHEMA_CHECK", "MIGRATION_REQUEST", "MIGRATION_RESPONSE",
            "DEFINITIONS_ANNOUNCE", "DEFINITIONS_UPDATE",
    ...
    private static final Set<String> CASSANDRA_PAXOS_VERBS = buildVerbSet(
            "PAXOS_PREPARE", "PAXOS_PROPOSE", "PAXOS_COMMIT",
            "PAXOS_PREPARE_REQ", "PAXOS_PREPARE_RSP", "PAXOS_PROPOSE_REQ",
            "PAXOS_PROPOSE_RSP", "PAXOS_COMMIT_REQ", "PAXOS_COMMIT_RSP",
            "PAXOS2_PREPARE_REQ", "PAXOS2_PREPARE_RSP", "PAXOS2_PROPOSE_REQ",
            "PAXOS2_PROPOSE_RSP", "PAXOS2_COMMIT_REMOTE_REQ", "PAXOS2_COMMIT_REMOTE_RSP",
            "PAXOS2_REPAIR_REQ", "PAXOS2_REPAIR_RSP");

    private static final Set<String> CASSANDRA_REPAIR_STREAM_VERBS = buildVerbSet(
            "REPAIR_MESSAGE", "REPAIR_REQ", "REPAIR_RSP",
            "PREPARE_MESSAGE", "VALIDATION_REQ", "VALIDATION_RSP",
            "SYNC_REQ", "SYNC_RSP", "ASYMMETRIC_SYNC_REQ",
            "STREAM_REQUEST", "STREAM_INITIATE", "STREAM_INIT_MESSAGE",
            "STREAM_REPLY", "STREAM_COMPLETE",
            "SNAPSHOT", "SNAPSHOT_MSG", "SNAPSHOT_REQ", "SNAPSHOT_RSP",
            "PREPARE_CONSISTENT_REQ", "PREPARE_CONSISTENT_RSP",
            "FINALIZE_PROPOSE_MSG", "FINALIZE_COMMIT_MSG", "FAILED_SESSION_MSG",
            "STATUS_REQ", "STATUS_RSP",
            "CLEANUP_MSG", "ANTICOMPACTION_REQ");

    private static final Set<String> CASSANDRA_READ_REPAIR_HINT_VERBS = buildVerbSet(
            "READ_REPAIR", "READ_REPAIR_REQ", "READ_REPAIR_RSP",
            "HINT", "HINT_REQ", "HINT_RSP",
            "HINTED_HANDOFF", "BATCH_REMOVE", "BATCH_REMOVE_REQ",
            "BATCH_REMOVE_RSP", "BATCH_STORE", "BATCH_STORE_REQ",
            "BATCH_STORE_RSP");

    private static final Set<String> CASSANDRA_BACKGROUND_VERBS = buildVerbSet(
            "GOSSIP_DIGEST_SYN", "GOSSIP_DIGEST_ACK", "GOSSIP_DIGEST_ACK2",
            "GOSSIP_SHUTDOWN", "GOSSIP_SYN", "GOSSIP_ACK", "GOSSIP_ACK2",
            "ECHO", "ECHO_MSG", "ECHO_REQ", "ECHO_RSP",
            "PING", "PING_REQ", "PING_RSP", "PING_MSG",
            "_TRACE", "_TEST_1", "_TEST_2", "REQUEST_RESPONSE",
            "INTERNAL_RESPONSE",
            "COUNTER_MUTATION_REQ", "COUNTER_MUTATION_RSP");
    ...
    private static final Set<String> CASSANDRA_GOSSIP_PAYLOAD_SUFFIXES = buildVerbSet(
            ...
            "GossipDigest", "EndpointState", "HeartBeatState",
            "EchoMessage", "PingMessage");

    // --- HDFS rpcService / rpcMethod sets ------------------------------------

    private static final Set<String> HDFS_NAMESPACE_MUTATION_METHODS = buildVerbSet(
            "create", "mkdirs", "rename", "rename2", "delete", "append",
            "truncate", "concat",
            "setReplication", "setStoragePolicy", "unsetStoragePolicy",
            "satisfyStoragePolicy", "setErasureCodingPolicy", "unsetErasureCodingPolicy",
            "setOwner", "setPermission", "setTimes", "setXAttr", "removeXAttr",
            "setAcl", "modifyAclEntries", "removeAclEntries", "removeDefaultAcl",
            "removeAcl",
            "createSymlink", "createEncryptionZone", "reencryptEncryptionZone",
            "addCacheDirective", "modifyCacheDirective", "removeCacheDirective",
            "addCachePool", "modifyCachePool", "removeCachePool",
            "setQuota", "setQuotaByStorageType",
            "allowSnapshot", "disallowSnapshot", "createSnapshot", "deleteSnapshot",
            "renameSnapshot", "getSnapshotDiffReport",
    ...
    private static final Set<String> HDFS_BLOCK_PIPELINE_METHODS = buildVerbSet(
            "addBlock", "abandonBlock", "complete", "getAdditionalDatanode",
            "updateBlockForPipeline", "updatePipeline", "getBlockLocations",
            "reportBadBlocks", "getDataEncryptionKey", "getListing",
            "getBlockLocationsForPath",
            // DatanodeProtocol
            "blockReport", "blockReceivedAndDeleted", "commitBlockSynchronization",
            "errorReport", "cacheReport", "blocksBeingWrittenReport",
            "slowDisksReport", "slowPeersReport", "blockReportForAllStorages");

    private static final Set<String> HDFS_JOURNAL_METHODS = buildVerbSet(
            "journal", "startLogSegment", "finalizeLogSegment",
            "getEditLogManifest", "getJournalState", "newEpoch",
            "prepareRecovery", "acceptRecovery", "getEditLogManifestFromJournal",
            "getEditLogStreams", "getJournalCTime",
            "heartbeat", "canRollBack", "discardSegments", "doPreUpgrade",
            "doUpgrade", "doFinalize", "doRollback");

    private static final Set<String> HDFS_HA_METHODS = buildVerbSet(
            "monitorHealth", "transitionToActive", "transitionToStandby",
            "transitionToObserver", "getServiceStatus",
            "cedeActive", "gracefulFailover", "checkAccess");

    private static final Set<String> HDFS_BACKGROUND_METHODS = buildVerbSet(
            "sendHeartbeat", "registerDatanode", "versionRequest",
            "getStats", "getDatanodeReport", "getDatanodeStorageReport",
            "getPreferredBlockSize", "rollingUpgrade", "getFileInfo",
            "getFileLinkInfo", "getContentSummary", "getServerDefaults",
            "getDelegationToken", "renewDelegationToken", "cancelDelegationToken",
            "rollEditLog", "saveNamespace", "restoreFailedStorage",
            "refreshNodes", "getListEncryptionZones",
            "listCacheDirectives", "listCachePools");

    // --- HBase rpcService / rpcMethod sets -----------------------------------

    private static final Set<String> HBASE_MUTATION_MULTI_METHODS = buildVerbSet(
            "Mutate", "mutate", "Multi", "multi", "bulkLoadHFile", "BulkLoadHFile",
            "prepareBulkLoad", "PrepareBulkLoad", "cleanupBulkLoad",
            "CleanupBulkLoad");

    private static final Set<String> HBASE_REGION_ADMIN_METHODS = buildVerbSet(
            "OpenRegion", "openRegion", "CloseRegion", "closeRegion",
            "OpenRegions", "openRegions", "CloseRegions", "closeRegions",
            "SplitRegion", "splitRegion", "CompactRegion", "compactRegion",
            "FlushRegion", "flushRegion", "MergeRegions", "mergeRegions",
            "WarmupRegion", "warmupRegion", "GetRegionInfo", "getRegionInfo",
            "StopServer", "stopServer", "RollWALWriter", "rollWALWriter",
            "ExecService", "execService", "ExecRegionServerService",
            "execRegionServerService", "ClearRegionBlockCache",
            "clearRegionBlockCache", "Replay", "replay", "UpdateFavoredNodes",
            "updateFavoredNodes", "CompactionSwitch", "compactionSwitch",
            "ExecuteProcedures", "executeProcedures",
            "ReplicateWALEntry", "replicateWALEntry");

    private static final Set<String> HBASE_MASTER_DDL_METHODS = buildVerbSet(
            "CreateTable", "createTable", "DeleteTable", "deleteTable",
            "ModifyTable", "modifyTable", "TruncateTable", "truncateTable",
            "EnableTable", "enableTable", "DisableTable", "disableTable",
            "CreateNamespace", "createNamespace", "DeleteNamespace",
            "deleteNamespace", "ModifyNamespace", "modifyNamespace",
            "AddColumn", "addColumn", "DeleteColumn", "deleteColumn",
            "ModifyColumn", "modifyColumn", "AddColumnFamily", "addColumnFamily",
            "DeleteColumnFamily", "deleteColumnFamily", "ModifyColumnFamily",
            "modifyColumnFamily", "MoveRegion", "moveRegion", "AssignRegion",
            "assignRegion", "UnassignRegion", "unassignRegion",
            "OfflineRegion", "offlineRegion",
            "RestoreSnapshot", "restoreSnapshot", "CloneSnapshot",
            "cloneSnapshot", "SnapshotTable", "snapshotTable",
            "DeleteSnapshot", "deleteSnapshot",
            "GrantPermission", "grantPermission", "RevokePermission",
            "revokePermission",
            "SetSplitOrMergeEnabled", "setSplitOrMergeEnabled");

    private static final Set<String> HBASE_BACKGROUND_METHODS = buildVerbSet(
            "RegionServerReport", "regionServerReport", "RegionServerStartup",
            "regionServerStartup", "ReportRSFatalError", "reportRSFatalError",
            "GetLastFlushedSequenceId", "getLastFlushedSequenceId",
            "ReportProcedureDone", "reportProcedureDone",
            "Heartbeat", "heartbeat", "GetClusterStatus", "getClusterStatus",
            "IsMasterRunning", "isMasterRunning", "IsBalancerEnabled",
            "isBalancerEnabled", "IsNormalizerEnabled", "isNormalizerEnabled",
            "IsCatalogJanitorEnabled", "isCatalogJanitorEnabled",
            "RunCatalogScan", "runCatalogScan", "RunCleanerChore", "runCleanerChore",
            "ListProcedures", "listProcedures",
            "Get", "get", "Scan", "scan", "CoprocessorService",
     ...
     */
    public static ProtocolFamily classify(String protocol, String messageType,
    ...
    private static ProtocolFamily classifyCassandra(String messageType, String messageKind,
        ...
        if (kind != null) {
            ...
            if (kind.startsWith("GOSSIP") || kind.equals("HEARTBEAT")
                    || kind.equals("ECHO") || kind.equals("PING")) {
                return ProtocolFamily.BACKGROUND;
            }
        }
